        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 text-text-secondary leading-relaxed">
            <div>
              ...
              <p>
                By accessing and using the {SITE_NAME} website located at{" "}
                {SITE_URL} (the &quot;Service&quot;), you agree to be bound by
                these Terms of Service (&quot;Terms&quot;). If you do not agree
                to these Terms, you must not access or use the Service. These
                Terms apply to all visitors, users, and applicants of the
                Service.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-3">
                ...
                <li>
                  Have a valid bank account capable of receiving ACH transfers
                </li>
                <li>
            ...
            <div>
              ...
              <p>
                By submitting a loan application, you authorize {SITE_NAME} to:
                verify the information provided, obtain your credit report from
                one or more credit bureaus, verify your employment and income,
                and contact you regarding your application via phone, email, or
                text message in accordance with your TCPA consent.
              </p>
              <p className="mt-3">
                Submitting an application does not guarantee loan approval.{" "}
                {SITE_NAME} reserves the right to approve or decline any
                application at its sole discretion based on creditworthiness,
            ...
            <div>
              ...
              <p>
                Completing an online application does not guarantee loan
                approval. A legally binding loan agreement is only formed once
                you have completed the phone underwriting process and provided
                an e-signature.
              </p>
              <p className="mt-3">
                If your application is approved, you will receive a separate
                Loan Agreement detailing the specific terms including the
                principal amount, the fixed {LOAN_LIMITS.minAPR.toFixed(2)}%
                APR, monthly payment, repayment schedule, and other material
                terms. {SITE_NAME} does not charge an origination fee, and there
            ...
            <div>
              ...
              <p>
                You represent and warrant that all information provided in your
                loan application is true, accurate, complete, and current.
                Providing false, misleading, or incomplete information may
                result in denial of your application, cancellation of an
                approved loan, or acceleration of any outstanding balance.
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">
                6. Use License &amp; Intellectual Property
              </h2>
              <p>
                Permission is granted to temporarily access the materials on the{" "}
                {SITE_NAME} website for personal, non-commercial use only.
              </p>
              <p className="mt-3">
                The Service and its original content, features, and
                functionality are owned by {SITE_NAME} and are protected by
