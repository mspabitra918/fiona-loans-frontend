          ...
          <div className="space-y-8 text-text-secondary leading-relaxed">
            <div>
              ...
              <p>
                ...
                personal information when you visit our website at {SITE_URL}{" "}
                and use our lending services. This policy complies with the
                Gramm-Leach-Bliley Act (GLBA) and applicable state privacy laws.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  Full legal name, date of birth, email address, phone number
                </li>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  To communicate with you about your application or account
                </li>
            ...
            <div>
              <h2 className="text-2xl font-bold text-text-primary mb-4">
                4. GLBA Compliance (United States)
              </h2>
              <p>
                In accordance with the Gramm-Leach-Bliley Act, we provide this
                notice of our information-sharing practices. We do not sell your
                personal financial information to third parties for marketing
                purposes. We may share your information with:
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-3">
                <li>Credit bureaus to verify creditworthiness</li>
                <li>
                  Service providers who assist in loan processing and servicing
                </li>
              ...
              <p className="mt-3">
                ...
                exercise your opt-out rights, contact us at {BUSINESS_EMAIL}.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                obligations, resolve disputes, and enforce our agreements. Loan
                records are retained for a minimum of 7 years as required by
                applicable law.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                browsing experience and collect analytics data. These include:
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-3">
                <li>
                ...
                <li>
                  <strong>Analytics Cookies:</strong> Google Analytics 4 for
                  usage patterns
                </li>
                <li>
                  <strong>Marketing Cookies:</strong> For advertising
                  attribution (Meta Pixel, Google Ads)
                </li>
              </ul>
              <p className="mt-3">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-3">
                ...
                <li>
                  Right to delete your personal data (subject to legal retention
                  requirements)
                </li>
            ...
            <div>
              ...
              <p>
                ...
                practices, contact our Privacy Officer:
              </p>
              <p className="mt-3">
                Email:{" "}
                <a
